...
[![MyBatis工作原理](http://118.25.100.99/img/img_spring/07.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))

[MyBatis工作原理](javascript:void(0))
...
[![Mybatis功能框架](http://118.25.100.99/img/img_spring/08.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))

[Mybatis功能框架](javascript:void(0))
...
[![Mybatis框架架构](http://118.25.100.99/img/img_spring/09.png?imageView2/2/w/1280/format/jpg/interlace/1/q/100)](javascript:void(0))

[Mybatis框架架构](javascript:void(0))
...
- Mybatis在处理 {}时，是原值传入，就是把 时，是原值传入，就是把{}替换成变量的值，相当于JDBC中的Statement编译
...
<mapper namespace="com.jourwon.mapper.EmployeeMapper" <!--批量保存员工 -->
    <insert id="addEmp">
